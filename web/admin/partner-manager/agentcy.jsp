...
<html >
    ...
    <body>
        <%            ArrayList<PartnerManager> all = null;
            ...
            PartnerManager partner = PartnerManager.getCacheByCode(code);
            if (partner == null) {
            ...
            all = pdao.getAllSubPartner(currentPage, max, name, code, status);

            int totalPage = 0;
            int totalRow = pdao.countAllSubPartner(name, code, status);
            ...
            <div class="main_content">
                ...
                <div class="center_content">
                    <div class="right_content">
                        <form onsubmit="return  validMonth();" action="<%=request.getContextPath() + "/admin/partner-manager/"%>" method="post">
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        <th scope="col" class="rounded-company"></th>
                                        <th scope="col" class="rounded"></th>
                                        <th scope="col" class="rounded-q4 redBoldUp">Đại lý con Của Đại lý: [<%=partner.getCode()%>] <%=partner.getName() %> </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td> 
                                            ...
                                            Trạng thái
                                            <select name="type">
                                                <option <%=status == -1 ? "selected='selected'" : ""%> value="-2">-Tất cả-</option>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="boder_right">
                                        ...
                                        <%
                                            if (onePartner.hasChild()) {
                                                out.print("<sub class='redBoldUp'>[Có ĐL con]<sub>");
                                            }
                                            if (onePartner.hasParent()) {
                                                PartnerManager parent = onePartner.getParentCache();
                                                out.print("<sup class='redBoldUp'>[TK QL: " + parent.getCode() + "]<sup>");
                                            }
                                        %>
                                    </td>
                                    <td align="left" class="boder_right">
                                    ...
                                    <td align="center" class="boder_right">
                                        ...
                                        %>
                                        <img src="<%= request.getContextPath()%>/admin/resource/images/lock.png"/>
                                        <%
                                            }
                                        %>
                                    </td>
                                    <%
                                        out.print(buildControl(request, userlogin,
                                                "/admin/partner-manager/edit.jsp?id=" + onePartner.getId(),
                                                "/admin/partner-manager/del.jsp?id=" + onePartner.getId())
                                        );
                                    %>
                                </tr>
                                <%
