...
<%    int id = RequestTool.getInt(request, "id");
    ...
    if (userlogin != null) {
        MsgBrandSubmit branLogdao = new MsgBrandSubmit();
...
<table id="rounded-corner">
    ...
    <tbody>
        <tr>
            ...
            <td class="boder_right">Time:</td>
            <td><%=DateProc.Timestamp2DDMMYYYYHH24MiSS(branLogdao.getTimeSend())%></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="9"><%=StringEscapeUtils.escapeHtml(branLogdao.getMessage())%></td>
        </tr>
        <tr>
            <td class="boder_right">MT: </td>
            <td colspan="9"><textarea onkeyup="demtin(this.value)" cols="55" rows="5"><%=StringEscapeUtils.escapeHtml(branLogdao.getMessage())%></textarea></td>
        </tr>
        <tr>
            <td class="boder_right">Số ký tự tin nhắn: </td>
            <td colspan="9"><span class="redBold" id="showtin"><%=branLogdao.getMessage().length()%></span></td>
        </tr>
    </tbody>
</table>
<%
