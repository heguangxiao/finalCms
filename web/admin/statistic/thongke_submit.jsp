...
<html >
    <head>
        <% session.setAttribute("title", "Thống kê Log Submit(CSKH)"); %>
...
//            alert(str);
    ...
    <body>
        <%
            ...
            allLog1 = smDao.statisticSubm2(userSender, cp_code, label, 0, provider, stRequest, endRequest, oper, result, groupBr, nation, ltypeb);
            allLog2 = smDao.statisticSubm3(userSender, cp_code, label, 0, provider, stRequest, endRequest, oper, result, groupBr, nation, ltypeb);
                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded-q4 "><b>Thống kê Log Submit(CSKH)</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
