...
<html >
    <head>
        <% session.setAttribute("title", "Biểu đồ theo ngày"); %>
    ...
    <body>
        <%            //-
            ...
            allLog = smDao.statisticSubmByDay(userSender, stRequest, endRequest, 0, ltypeb);
        %>
                ...
                <div class="center_content">
                    <div class="right_content">
                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded-q4"><b>Biểu đồ theo ngày</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select style="width: 400px" id="_userSender" name="userSender">
                                                ...
                                                <option <%=userSender.equals(oneAcc.getUserName()) ? "selected='true'" : ""%> 
                                                    ...
                                                    img-data="<%=(oneAcc.getStatus() == 1 ? "" : request.getContextPath() +"/admin/resource/images/lock1.png")%>" >[<%=oneAcc.getUserName()%>]<%=oneAcc.getFullName()%> [<%= oneAcc.getUserType() == 0 ? "-- Khách hang lẻ --" : "-- Đại lý --"%>]</option>
                                                <%
                                                    }
                                                %>
                                            </select>
                        ...
                        <table id="rounded-corner">
                            <tr>
                                <td class="boder_right" colspan="3" style="font-weight: bold;color: blue;width: 352px">Tổng MT</td>
