...
<%
    try {
        ...
        BBDS smDao = new BBDS();
        MsgBrandSubmit smDao2 = new MsgBrandSubmit();
        ...
        allLog1 = smDao2.statisticSubm2(userSender, cp_code, _label, 0, provider, stRequest, endRequest, oper, result, groupBr, nation, ltypeb);
        allLog2 = smDao2.statisticSubm3(userSender, cp_code, _label, 0, provider, stRequest, endRequest, oper, result, groupBr, nation, ltypeb);
        ...
        for (MsgBrandSubmit elem : allLog) {
            BBDS bbds = new BBDS();
            bbds.setGroup(elem.getBrGroup());
            bbds.setResult(elem.getResult());
            bbds.setTelco(elem.getOper());
            bbds.setTotal(elem.getTotalSms());
            bbds.setType(elem.getType());
            all.add(bbds);
        }
