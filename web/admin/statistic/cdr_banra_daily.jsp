...
//            $.noConflict();
    ...
    <body>
        <%  
            ...
            ArrayList<CDRSubmit> allLog = dao.statisticSale_forDL(cp_code, label, type,  stRequest, endRequest, oper, result, groupBr);
            String urlExport = request.getContextPath() + "/admin/statistic/exp/exp_CDR_ban_dl.jsp?";
            String dataGet = "";
            dataGet += "type=" + type;
            ...
            <div class="main_content">
                ...
                <div class="center_content">
                    <div class="right_content">
                        <!-- Tìm kiếm-->
                        <form onsubmit="return  validMonth();" action="<%=request.getContextPath() + "/admin/statistic/cdr_banra_daily.jsp"%>" method="post">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            &nbsp;
                                            Telco
                                            <select class="select3" name="oper">
                                                <option value="">+Tất cả+</option>
                                                <option value="">+ Tất cả +</option>
                                                <%
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            %>
                                            <select style="width: 450px" id="_agentcy_id" name="cp_code">
                                                <option value="">******** Tất cả ********</option>
                                                <%
                        ...
                        <table id="example" class="display" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="rounded Bold"><b>CP CODE</b></th>
                                    <th scope="col" class="rounded Bold"><b>Brand Name</b></th>
                                    <th scope="col" class="rounded Bold"><b>Nhà mạng</b></th>
                                    <th scope="col" class="rounded Bold"><b>Tổng tin</b></th>
                                    <th scope="col" class="rounded Bold"><b>Hướng</b></th>
                                    <th scope="col" class="rounded Bold"><b>Nhóm</b></th>
                                    <th scope="col" class="rounded Bold"><b>Kết quả</b></th> 
                                </tr>
                            </thead>
                            <tbody>
                                <%
                                ...
                                <tr>
                                    ...
                                    <td class="boder_right boder_left"><%=oneBrand.getCpCode()%></td>
                                    ...
                                    <td class="boder_right" align="center"><%=oneBrand.getGateWay()%></td>
