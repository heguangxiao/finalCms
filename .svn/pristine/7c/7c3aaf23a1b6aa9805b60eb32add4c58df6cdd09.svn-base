...
<%@page import="gk.myname.vn.utils.FileUtils"%>
...
<%@page import="gk.myname.vn.entity.MsgBrandCustomer"%>
<%@page import="gk.myname.vn.utils.SMSUtils"%>
<%@page import="gk.myname.vn.utils.ExcelUtil"%>
<%@page import="gk.myname.vn.multipart.request.MultipartFile"%>
<%@page import="gk.myname.vn.entity.ListCustomer"%>
...
<%  
    ...
    if (file.getExtentsion().endsWith("xls")) {
        // Excel 2003
        listData = MsgBrandAds.readXsl(file.getInputStream(), 0, cpDao, "", "");
        FileUtils.writeFileToDisk(file.getByteFromFile(), pathFileResult + cpid + ".xls");
    } else if (file.getExtentsion().endsWith("xlsx")) {
        // Excel > 2003
        listData = MsgBrandAds.readXslx(file.getInputStream(), 0, cpDao, "", "");
