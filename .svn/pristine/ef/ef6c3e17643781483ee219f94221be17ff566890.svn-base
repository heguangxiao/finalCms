...
<html >
    <head>
        <% session.setAttribute("title", "Quản lý từ khóa Black List"); %>
    ...
    <body>
        <%  //-          
            ...
            String urlExport = request.getContextPath() + "/admin/key-blacklist/export.jsp?";
            String dataGet = "";
            dataGet += "page=" + currentPage;
            dataGet += "&telco=" + telco;
            dataGet += "&keyVn=" + keyVn;
            dataGet += "&keyEn=" + keyEn;
            dataGet += "&brandname=" + brandname;
            urlExport += dataGet;
        %>
                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded"></th>
                                        <th scope="col" class="rounded"><b>Quản lý từ khóa Black List</b></th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input size="10" type="text" name="keyvn"/>
                                        </td>
                                        <td>
                                            <span class="redBold">Key Tiếng Anh </span>
                                            <input size="10" type="text" name="keyen"/>
                                        </td>
                                        <td>
