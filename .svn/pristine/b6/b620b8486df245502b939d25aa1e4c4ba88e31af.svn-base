    ...
    <body>
        <%
            ...
            if (request.getParameter("submit") != null) {
                ...
                cm.setCommand(CustodyMessage.TOPUP_ACTION);
                cm.setKeyapi(CustodyMessage.TOPUP_KEY);
                ...
                if (resultAdd == 1) {
                    ...
                    session.setAttribute("mess", "App đang xử lý thêm tiền cho tài khoản " + accountname);
                } else {
                    UserAction log = new UserAction(userlogin.getUserName(),
                        UserAction.TABLE.accounts.val,
                        UserAction.TYPE.EDIT.val,
