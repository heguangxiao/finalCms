...
<%@page import="gk.myname.vn.entity.MsgBrandSubmit"%><%@page import="gk.myname.vn.admin.Account"%><%@page import="gk.myname.vn.utils.DateProc"%><%@page import="gk.myname.vn.utils.RequestTool"%><%@include file="/admin/includes/header.jsp" %><%@ page contentType="text/html; charset=utf-8" %>
