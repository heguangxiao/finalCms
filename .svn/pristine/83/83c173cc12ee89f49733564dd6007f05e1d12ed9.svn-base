...
<html >
    <head>
        <% session.setAttribute("title", "Quản lý nhóm nhà cung cấp"); %>
                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded"><b>Quản lý nhóm nhà cung cấp</b></th>
                                ...
                                <tbody>
                                    <tr>
                                        <td></td>                                        
                                        <td class="redBold">Tên nhóm nhà cung cấp <input type="text" name="name"/></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="boder_right">
                                            ...
                                            <%=buildControl(request, userlogin,
                                                    "/admin/group_provider/edit.jsp?id=" + one.getId(),
                                                    "/admin/group_provider/del.jsp?id=" + one.getId())%>
                                    </tr>
                                <%
                                    }
                                %>
