                            ...
                            <table  align="center" id="rounded-corner">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input size="50" type="text" id="phoneInput" name="phone" value=""/>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>                                        
                                        ...
                                        <td style="color: red">VD : +84975034483</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            <input onclick="return convertPhone()" class="button" type="submit" name="submit" value="Thêm mới"/>
