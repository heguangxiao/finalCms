...
<html >
    <head>
        <% session.setAttribute("title", "Nhãn chờ khai báo"); %>
                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded-q4"><b>Nhãn chờ khai báo</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select class="select3" style="width: 150px" name="status">
                                                <option <%=status == 2 ? " selected='selected'" : ""%> value="2">Chờ kích hoạt</option>
                                            </select>
                                            &nbsp;&nbsp;&nbsp;
...
//                                                    for (let el of document.querySelectorAll('.dt'+name)) el.style.display = 'none';
                                                ...
                                                %>
                                                    <div style="float: left">
                                                        ...
                                                        <div style="float: left">
                                                            ...
                                                            %>
                                                            <span style="color: blue;font-weight: bold">Nhóm : <%=groupProvider!= null ? groupProvider.getName() : ""%></span>
                                                            <%
                                                            }
                                                            %>
                                                            <br/><!--
                                        ...
                                        <%=buildControl(request, userlogin,
                                                "/admin/brand-declare/edit.jsp?id=" + oneBrand.getId(),
                                                "/admin/brand-declare/delBrand.jsp?id=" + oneBrand.getId())%>
                                    </tr>
                                    <%}%>
                                </tbody>
                            </table>
