...
<html >
    <head>
        <% session.setAttribute("title", "Lịch sử yêu cầu từ đại lý"); %>
...
<script type="text/javascript" language="javascript">
    function demtin(i) {        
        ...
        <%            ArrayList<MsgBrandRequest> all = null;
            ...
            all = logDao.getAllLog_MsgReq2(currentPage, maxRow, userSender, cp_code, label, 0, result,  stRequest, endRequest, phone, telco, err_code, tranId, nation, ltypeb);
            int totalPage = 0;
            int totalRow = logDao.countAllLog_MsgReq2(userSender, cp_code, label, 0, result,  stRequest, endRequest, phone, telco, err_code, tranId, nation, ltypeb);
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded-q4">
                                            <b>Lịch sử yêu cầu từ đại lý (kết quả này chỉ là nhận thành công)</b>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
