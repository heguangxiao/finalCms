...
<%
    try {
        ...
        all1 = submDao.getMsgSubmitLog2(currentPage, totalRow, userSender, cp_code, label, 0, result, provider, stRequest, endRequest, phone,
                telco, err_code,tranId, nation, ltypeb);
        all2 = submDao.getMsgSubmitLog3(currentPage, totalRow, userSender, cp_code, label, 0, result, provider, stRequest, endRequest, phone,
                telco, err_code,tranId, nation, ltypeb);
