...
<%
    try {
        ...
        all1 = smDao.statisticSubm2(userSender, cp_code, _label, 1, provider, stRequest, endRequest, oper, result, groupBr, nation, ltypeb);
        all2 = smDao.statisticSubm3(userSender, cp_code, _label, 1, provider, stRequest, endRequest, oper, result, groupBr, nation, ltypeb);
        if (all1.size() > 0) {
