...
<html >
    <head>
        <% session.setAttribute("title", "Lịch sử gửi tin nhắn full"); %>
...
<script type="text/javascript" language="javascript">
    function demtin(i) {        
        ...
        <%
            ...
            all1 = logDao.getMsgSubmitLog2(currentPage, maxRow, userSender, cp_code, label, 0, result, provider, stRequest, endRequest, phone,
                    telco, err_code,tranId, nation, ltypeb);
            all2 = logDao.getMsgSubmitLog3(currentPage, maxRow, userSender, cp_code, label, 0, result, provider, stRequest, endRequest, phone,
                    telco, err_code,tranId, nation, ltypeb);
            ...
            int totalPage = 0;
            int totalRow1 = logDao.countMsgSubmitLog2(userSender, cp_code, label, 0, result, provider, stRequest, endRequest, phone, telco, err_code, tranId, nation, ltypeb);
            int totalRow2 = logDao.countMsgSubmitLog3(userSender, cp_code, label, 0, result, provider, stRequest, endRequest, phone, telco, err_code, tranId, nation, ltypeb);
            int totalRow = totalRow1 + totalRow2;
            totalPage = (int) totalRow / maxRow;
            if (totalRow % maxRow != 0) {
                totalPage++;
            }
            String urlExport = request.getContextPath() + "/admin/statistic/exp/exp_submit.jsp?";
            String dataGet = "";
            ...
            <div class="main_content">
                ...
                <div class="center_content">
                    <div class="right_content">
                        <!-- Tìm kiếm-->
                        <form onsubmit="return validMonth();"  action="<%=request.getContextPath() + "/admin/statistic/history/submit_full.jsp"%>" method="post">
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        <th scope="col" class="rounded-company"></th>
                                        <th scope="col" class="rounded"></th>
                                        <th scope="col" class="rounded-q4"><b>Lịch sử gửi tin nhắn full</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
