...
<%
    try {
        ...
        allLog1 = smDao2.statisticSubm2(userSender, cp_code, _label, 1, provider, stRequest, endRequest, oper, result, groupBr, nation, ltypeb);
        allLog2 = smDao2.statisticSubm3(userSender, cp_code, _label, 1, provider, stRequest, endRequest, oper, result, groupBr, nation, ltypeb);
