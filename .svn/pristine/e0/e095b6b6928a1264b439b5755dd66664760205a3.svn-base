                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded-q4 redBoldUp">Tìm kiếm tài khoản đại lý</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <%=buildControl(request, userlogin,
                                            ...
                                            (oneAdmin.getStatus() == 404) ? "javascript:void(0)" : "/admin/customer/agency/del.jsp?id=" + oneAdmin.getAccID()
                                    )%>
                                </tr>
                                <%
                                    }
