...
<html >
    <head>
        <% session.setAttribute("title", "Quản lý tài khoản khách hàng lẻ"); %>
    ...
    <body>
        <%            if (!userlogin.checkView(request)) {
            ...
            maxRow = 50;
            int totalPage = 0;
            int totalRow = dao.countAllUserAndStatus(key,status, partner);
            totalPage = (int) totalRow / maxRow;
            if (totalRow % maxRow != 0) {
                totalPage++;
            }
            all = dao.getAllUserWithStatus(currentPage, maxRow, key, status, partner);
        %>
                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded-q4"><b>Tìm kiếm tài khoản khách hàng lẻ</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td class="redBold">Trạng thái</td>
                                        <td>
                                            <select name="status">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="boder_right">
                                        <div align="center">
                                            <div>
                                                <%=oneAdmin.getMaxBrand()%>
                                                <a href="<%= request.getContextPath()%>/admin/customer/khle/addTotalSMS.jsp?id=<%=oneAdmin.getAccID()%>">
                                                    <img src="<%= request.getContextPath()%>/admin/resource/images/Add.png"/>
                                                </a>
                                            </div>
                                        </div>
                                    </td>
