...
<html >
    <head>
        <% session.setAttribute("title", "Thống kê chi tiết theo ngày"); %>
    ...
    <body>
        <%           
            ...
            allLog = smDao.statisticSubm_ByDay2(userSender, cp_code, label, 0, provider, oper, result, groupBr, stRequest, endRequest, nation, ltypeb);
            ...
            String urlExport2 = request.getContextPath() + "/admin/statistic/exp/export_tk_dt_bd.jsp?";
                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded-q4"><b>Thống kê chi tiết theo ngày</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td> 
                                            <input value="<%=stRequest%>" id="stRequest" class="dateproc" style="width: 162px" type="text" name="stRequest"/>
                                            &nbsp;&nbsp;
                                            <span class="redBold">Đến</span>
                                            <input value="<%=endRequest%>" id="endRequest" class="dateproc" style="width: 162px" type="text" name="endRequest"/>
                                            &nbsp;&nbsp;
                                            <span class="redBold">Kết Quả</span>
                                            <select class="select3" style="width: 175px" name="result">
                                            ...
                                            <select class="select3" style="width: 175px" name="groupBr">
                                                <option value="">Tất cả</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select onchange="changeCP()" style="width: 400px" id="_userSender" name="userSender">
                                                ...
                                                %>
                                                <option <%=userSender.equals(oneAcc.getUserName()) ? "selected='true'" : ""%>
                                            ...
                                            <select class="select3" style="width: 400px;float: right" name="provider">
                                                <option value="">Tất cả</option>
                                                <%
                                                    for (Provider one : allPrv) {
                                                %>
                                                <option <%=(provider.equals(one.getCode())) ? "selected ='true'" : ""%> value="<%=one.getCode()%>"><%=one.getName()%></option>
                                                <%
                                                    }
                                                %>
                                            </select>
                                    ...
                                    <tr align="center">
                                        <td colspan="3">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input onclick="window.open('<%=urlExport2%>')" class="button" type="button" name="button" value="Thống kê theo ngày"/>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
