...
public class SMSUtils {
    ...
    public static String CHINA_MOBILE_OPERATOR = NetworkTelco.CHINA.CHINAMOBILE.getVal();
    public static String CHINA_UNICOM_OPERATOR = NetworkTelco.CHINA.CHINAUNICOM.getVal();
    public static String CHINA_TELECOM_OPERATOR = NetworkTelco.CHINA.CHINATELECOM.getVal();
    ...
    public static enum OPER {
        ...
        CHINAMOBILE(NetworkTelco.CHINA.CHINAMOBILE.getVal()),//
        CHINAUNICOM(NetworkTelco.CHINA.CHINAUNICOM.getVal()),
        CHINATELECOM(NetworkTelco.CHINA.CHINATELECOM.getVal());
    ...
    public static int countSmsBrandQC(String mess, String oper) {
        ...
        if (!Tool.checkNull(mess)) {
            ...
            if (oper.equals(VIETTEL_OPERATOR)) {
                ...
                ////////////////////
            }else if (oper.equals(CHINA_MOBILE_OPERATOR)) {
                if (length <= 127) {
                    count = 1;
                } else if (length > 127 && length <= 273) {
                    count = 2;
                ...
                ////////////////////
            }else if (oper.equals(CHINA_UNICOM_OPERATOR)) {
                if (length <= 127) {
                    count = 1;
                } else if (length > 127 && length <= 273) {
                    count = 2;
                ...
                ////////////////////
            }else if (oper.equals(CHINA_TELECOM_OPERATOR)) {
                if (length <= 127) {
                    count = 1;
                } else if (length > 127 && length <= 273) {
                    count = 2;
