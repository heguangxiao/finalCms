...
public class MsgBrandAds {
    ...
    public ArrayList<MsgBrandAds> staticAll(String startTime, String endTime, String result, String user, String label,
        String oper, String nation, String cpcode, String campaignId) {
        ArrayList<MsgBrandAds> allList = new ArrayList<>();
        Connection conn = null;
        PreparedStatement pstm = null;
        ResultSet rs = null;
        String sql = "SELECT DATE_FORMAT(CAMPAIGN_TIME,'%d/%m/%Y') AS TIME_SEND,"
                + " SUM(TOTAL_SMS) AS TOTAL_SMS,USER_SENDER,LABEL,OPER,RESULT,CP_CODE,TRANS_ID "
        ...
        try {
            ...
            sql += " GROUP BY DATE_FORMAT(CAMPAIGN_TIME,'%d/%m/%Y'),USER_SENDER,LABEL,OPER,CP_CODE,RESULT,TRANS_ID";
            ...
            while (rs.next()) {
                ...
                oneAds.setTranId(rs.getString("TRANS_ID"));
                allList.add(oneAds);
            }
