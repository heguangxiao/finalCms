...
public class MsgBrandSubmit {
    ...
    public ArrayList<MsgBrandSubmit> statisticSubm(String userSender, String cpCode, String label, int type, String provider, String stRequest,
        ...
        PreparedStatement pstm = null;
        ResultSet rs = null;
        String sql = " SELECT SUM(TOTAL_SMS) AS TOTAL_SMS,CP_CODE,OPER,Cast(LABEL As BINARY) as LABEL,RESULT,TYPE,SEND_TO,BR_GROUP,SEND_TO ";
        sql += " FROM MSG_BRAND_SUBMIT " + buidPartition(stRequest) + " A WHERE 1=1 ";
        if (!Tool.checkNull(userSender)) {
            sql += " AND USER_SENDER = ?";
        }
    ...
    public ArrayList<MsgBrandSubmit> statisticSubm2(String userSender, String cpCode, String label, int type, String provider, String stRequest,
            String endRequest, String oper, int result, String groupBr, String nation, int ltypeb) {
        ArrayList<MsgBrandSubmit> all = new ArrayList<>();
        Connection conn = null;
        PreparedStatement pstm = null;
        ResultSet rs = null;
        String sql = " SELECT SUM(TOTAL_SMS) AS TOTAL_SMS,CP_CODE,OPER,Cast(LABEL As BINARY) as LABEL,RESULT,TYPE,SEND_TO,BR_GROUP,LONGCODE ";
        sql += " FROM MSG_BRAND_SUBMIT " + buidPartition(stRequest) + " A WHERE 1=1 ";
        if (!Tool.checkNull(userSender)) {
            sql += " AND USER_SENDER = ?";
        }
        ...
        sql += " GROUP BY CP_CODE,OPER,Cast(LABEL As BINARY),RESULT,TYPE,SEND_TO,BR_GROUP,LONGCODE";
    ...
    public ArrayList<MsgBrandSubmit> statisticSubm3(String userSender, String cpCode, String label, int type, String provider, String stRequest,
            String endRequest, String oper, int result, String groupBr, String nation, int ltypeb) {
        ArrayList<MsgBrandSubmit> all = new ArrayList<>();
        Connection conn = null;
        PreparedStatement pstm = null;
        ResultSet rs = null;
        String sql = " SELECT SUM(TOTAL_SMS) AS TOTAL_SMS,CP_CODE,OPER,Cast(LABEL As BINARY) as LABEL,RESULT,TYPE,SEND_TO,BR_GROUP,LONGCODE ";
        sql += " FROM MSG_BRAND_SUBMIT_PERDAY " + buidPartition(stRequest) + " A WHERE 1=1 ";
        if (!Tool.checkNull(userSender)) {
            sql += " AND USER_SENDER = ?";
        }
        if (!Tool.checkNull(cpCode)) {
...
//                pstm.setString(i++, endRequest + " 23:59:59");
    ...
    public ArrayList<MsgBrandSubmit> getMsgSubmitLog2(int page, int max, String userSender, String cp_code, String _label, int type, int result,
            String provider, String stRequest, String endRequest, String phone, String telco, int err_code, String tranId, String nation, int ltypeb) {
        ArrayList<MsgBrandSubmit> all = new ArrayList<>();
        Connection conn = null;
        PreparedStatement pstm = null;
        ResultSet rs = null;
...
//                pstm.setString(i++, endRequest + " 23:59:59");
    ...
    public ArrayList<MsgBrandSubmit> getMsgSubmitLog3(int page, int max, String userSender, String cp_code, String _label, int type, int result,
            String provider, String stRequest, String endRequest, String phone, String telco, int err_code, String tranId, String nation, int ltypeb) {
        ArrayList<MsgBrandSubmit> all = new ArrayList<>();
        Connection conn = null;
        PreparedStatement pstm = null;
        ResultSet rs = null;
        String sql = "SELECT * FROM MSG_BRAND_SUBMIT_PERDAY " + buidPartition(stRequest)
                + " A WHERE 1=1 ";
        if (type != -1) {
            sql += " AND A.TYPE = ?";
        }
...
//                pstm.setString(i++, endRequest + " 23:59:59");
    ...
    public int countMsgSubmitLog2(String userSender, String cp_code, String _Label, int type, int result, String provider, String stRequest,
            String endRequest, String _phone, String telco, int err_code, String tranId, String nation, int ltypeb) {
        int count = 0;
        Connection conn = null;
        PreparedStatement pstm = null;
        ResultSet rs = null;
...
//                pstm.setString(i++, endRequest + " 23:59:59");
    ...
    public int countMsgSubmitLog3(String userSender, String cp_code, String _Label, int type, int result, String provider, String stRequest,
            String endRequest, String _phone, String telco, int err_code, String tranId, String nation, int ltypeb) {
        int count = 0;
        Connection conn = null;
        PreparedStatement pstm = null;
        ResultSet rs = null;
        String sql = "SELECT count(*) FROM MSG_BRAND_SUBMIT_PERDAY " + buidPartition(stRequest) + " WHERE 1=1 ";
        if (type != -1) {
            sql += " AND TYPE = ?";
        }
        if (result != -1) {
