...
<html >
    <head>
        <% session.setAttribute("title", "Quản lý thông tin đại lý"); %>
                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded-q4"><b>Tìm kiếm đại lý</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                        ...
                        <table align="center" id="rounded-corner" summary="Msc Joint Stock Company" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="boder_right">
                                        <a href="<%=request.getContextPath()%>/admin/contract/index.jsp?partnerID=<%=onePartner.getId()%>">
                                            Xem HĐ
                                        </a>
                                    </td>
                                    <td align="center" class="boder_right">
                                        <a href="<%=request.getContextPath()%>/admin/customer/agency/index.jsp?partner=<%=onePartner.getCode()%>">
                                    ...
                                    <%=buildControl(request, userlogin,
                                            ...
                                            "/admin/partner-manager/del_ever.jsp?id=" + onePartner.getId())%>
                                </tr>
                                <%
                                    }
                                %>
