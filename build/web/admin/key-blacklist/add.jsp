        ...
        <%            //--
            ...
            if (request.getParameter("submit") != null) {
                ...
                if (Tool.checkNull(keyvn)) {
                    session.setAttribute("mess", "Không được để Từ khóa trống!");
                    response.sendRedirect(request.getContextPath() + "/admin/key-blacklist/add.jsp");
                    return;
                }
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            ...
                                            <input class="button" onclick="window.location.href = '<%=request.getContextPath() + "/admin/key-blacklist/index.jsp"%>'" type="reset" name="reset" value="Hủy"/>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
<!--<script type="text/javascript" language="javascript">
    function changedemtin(i) {        
        document.getElementById('demtin').innerHTML = i.length;
    }
</script>-->