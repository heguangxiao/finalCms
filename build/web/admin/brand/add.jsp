        ...
        <%  //--          
            ...
            if (request.getParameter("submit") != null) {
                if (owner_id == 0) {
                    ...
                    response.sendRedirect(request.getContextPath() + "/admin/brand/add.jsp");
                    return;
                }
                String telco;
                int duplicate;
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="boder_right" colspan="2">
                                            <input size="10" type="text" name="brandName"/>
                                        </td>
                                        <td colspan="2" align="left">Account</td>
                                        <td colspan="3" align="left">
                                            <select class="select3" name="owner_id">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" class="boder_right" colspan="2"><b>Y/c thêm của Ncc</b></td>
                                        <td align="center" colspan="2"><b>QC</b>
                                    ...
                                    <tr class="trdtgt<%=i%>" style="display: none">
                                        ...
                                        <td align="center" class="boder_right" colspan="2">
                                            ...
                                            <br/>
                                            <select style="width: 73px" class="select3" name="group<%=i%>">
                                        ...
                                        <td align="center" class="boder_right" colspan="2">
                                            ...
                                            <br/>
                                            <select style="width: 78px;float: left" class="select3" name="groupunicode<%=i%>">
                                                <option value="0">NHÓM</option>
                                                <option value="N1">N1</option>
                                                <option value="N2">N2</option>
                                                <option value="N3">N3</option>
