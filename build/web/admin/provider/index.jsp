...
<html >
    <head>
        <% session.setAttribute("title", "Nhà cung cấp"); %>
                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded-q4"><b>Nhà cung cấp</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td></td>
                                        <td class="redBold">Provider </td>
                                        <td>
                        ...
                        <table align="center" id="rounded-corner" summary="Msc Joint Stock Company" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="boder_right" align="left">
                                        <%=oneProvi.getAllow_telco() == null ? "" : oneProvi.getAllow_telco().equals("null") ? "" : oneProvi.getAllow_telco()%>
                                    </td>                                
