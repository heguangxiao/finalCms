        ...
        <%  //--          
            ...
            if (request.getParameter("submit") != null) {
                ...
                String code = RequestTool.getString(request, "code");
                    ...
                    if (!code.equals(oneProvi.getCode())) {   
                ...
                if (oneProvi.updateProvider(oneProvi)) {
                    ...
                    message += "Cập nhật dữ liệu nhà cung cấp thành công!<br/>";
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            %>
                                            <input <%=oneProvi.getAllow_telco() == null ? "" : oneProvi.getAllow_telco().contains(one.getTelco_code()) ? "checked='checked'" : ""%>
                                                type="checkbox" name="allow_telco" value="<%=one.getTelco_code()%>" />
