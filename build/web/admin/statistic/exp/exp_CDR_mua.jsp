...
<%
    try {
        ...
        String strOrder = "ORDER BY B.TOTAL_SMS DESC";
        ArrayList<CDRSubmit> all = cdrDao.statisticBuy(_label, type, provider, stRequest, endRequest, oper, result, groupBr);
        out.clear();
...
//        Map<String, Object[]> data = new HashMap<String, Object[]>();
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment; filename=CDR-Buy-Report-" + DateProc.createDDMMYYYY() + ".xls");
