...
<%
    try {
        ...
        if (Tool.checkNull(provider)) {
            ...
            all1 = smDao.statisticSubm2(userSender, cp_code, _label, 1, "", stRequest, endRequest, oper, 1, groupBr, nation, ltypeb);
            all2 = smDao.statisticSubm3(userSender, cp_code, _label, 1, "", stRequest, endRequest, oper, 1, groupBr, nation, ltypeb);
            if (all1.size() > 0) {
